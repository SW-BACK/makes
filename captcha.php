...
$image = imagecreatetruecolor(100, 30);    //1>设置验证码图片大小的函数
  ...
  $bgcolor = imagecolorallocate($image,30,255,255); //#ffffff
  ...
  for($i=0;$i<4;$i++){
    ...
    $fontsize = 6;    
    //设置字体颜色，随机颜色
    $fontcolor = imagecolorallocate($image, rand(0,60),rand(0,120), rand(0,120));      //0-120深颜色
    //设置数字
    $fontcontent = dechex(mt_rand(0,15));
